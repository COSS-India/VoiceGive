...
import 'package:bhashadaan/services/password_encryption_service.dart';
...
void main() {
  group('PasswordEncryptionService Tests', () {
    test('should encrypt and decrypt password correctly', () {
      ...
      final encryptedPassword = PasswordEncryptionService.encryptPassword(testPassword);
      ...
      final decryptedPassword = PasswordEncryptionService.decryptPassword(encryptedPassword);
    ...
    test('should handle empty password', () {
      ...
      final encryptedPassword = PasswordEncryptionService.encryptPassword(emptyPassword);
      final decryptedPassword = PasswordEncryptionService.decryptPassword(encryptedPassword);
    ...
    test('should handle special characters in password', () {
      ...
      final encryptedPassword = PasswordEncryptionService.encryptPassword(specialPassword);
      final decryptedPassword = PasswordEncryptionService.decryptPassword(encryptedPassword);
    ...
    test('should handle unicode characters in password', () {
      ...
      final encryptedPassword = PasswordEncryptionService.encryptPassword(unicodePassword);
      final decryptedPassword = PasswordEncryptionService.decryptPassword(encryptedPassword);
    ...
    test('should validate encrypted format correctly', () {
      ...
      expect(PasswordEncryptionService.isValidEncryptedFormat(encryptedPassword), isTrue);
      expect(PasswordEncryptionService.isValidEncryptedFormat('invalid:format'), isFalse);
    ...
    test('should produce consistent encryption results', () {
      ...
      final encrypted1 = PasswordEncryptionService.encryptPassword(testPassword);
      final encrypted2 = PasswordEncryptionService.encryptPassword(testPassword);
