...
class ProfileService {
  static Future<dynamic> registration({required String firstName, required String lastName, required String ageGroup, required String gender, required String mobileNo, String? email, required String country, required String state, required String district, String? preferredLanguage}) async {
  ...
  'preferredLanguage': preferredLanguage?? 'English'
    ...
    final response = await http.post(
        Uri.parse(ApiUrl.userRegisterUrl),
        headers: {
